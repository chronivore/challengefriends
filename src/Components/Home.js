    ...
    <Row>
      <Col sm="4">
        <Card body>
          ...
          <Link to='/restaurant' className="btn btn-secondary"><Button>Check it out!</Button></Link>
        </Card>
      </Col>
      <Col sm="4">
        <Card body>
          ...
          <Link to='/restaurant' className="btn btn-secondary"><Button >What's the weather today?</Button></Link>
        </Card>
      </Col>
      <Col sm="4">
        <Card body>
